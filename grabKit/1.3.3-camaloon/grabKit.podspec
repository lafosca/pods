Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
				GrabKit allows you to retrieve photos from  :
					...
					* ... and more to come.
					DESC
  s.homepage     = "https://github.com/lafosca/grabKit"
  s.screenshots  = "https://github.com/lafosca/grabKit/blob/master/doc/demo.gif"

  s.license      = { :type => 'MIT', :file => 'LICENSE.txt' }

  s.author       = { "Pierre-Olivier Simonard" => "pierre.olivier.simonard@gmail.com" }
  
  s.source       = { :git => "https://github.com/lafosca/grabKit.git", :tag => "v1.3.3-camaloon" }
